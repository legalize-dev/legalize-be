...
5° utiliser une gestion de l'entreprise de qualité en ce qui concerne :

a) l'insertion, la formation et l'accompagnement de travailleurs de groupe-cible visant la promotion de carrières durables;

b) l'entreprise socialement responsable;

c) l'ancrage social;

d) la transition vers le circuit économique normal;
