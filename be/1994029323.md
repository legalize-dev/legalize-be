...
L'avis qui indique le classement des temporaires, la fonction à conférer, le volume des prestations des emplois offerts, les conditions requises dans le chef des candidats ainsi que la forme et le délai dans lesquels les candidatures doivent être introduites, est communiqué à tous les membres temporaires du personnel qui sont au service du pouvoir organisateur et qui figurent au classement des prioritaires.
...
Le nombre de jours acquis dans une fonction à prestations incomplètes aui ne comporte pas la moitié du nombre requis pour la fonction à prestations complètes, est réduit de moitié.
...
3° exercer une fonction à prestations complètes dans un établissement dépendant du même pouvoir organisateur;
