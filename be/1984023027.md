...
Sont pris en considération pour le calcul de ce montant les indemnités, traitements ou jetons de présence découlant de l'exercice d'un mandat, d'une fonction ou charge publics d'ordre politique. [¹ Les indemnités, traitements ou jetons de présence découlant de l'exercice de fonctions spéciales, telles que déterminées par le règlement du Parlement, sont également pris en considération pour le calcul de ce montant.]¹
