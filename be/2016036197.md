...
a) ils forment un ensemble spatial d'un seul tenant;

b) ils sont reliés entre eux de plein droit ou de fait, plus particulièrement sur le plan financier, commercial ou spatial;
