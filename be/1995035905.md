...
§ 3. Durant cette période transitoire de trois années d'activité, les critères de subventionnement suivants sont applicables aux organisations visées aux § 1er et § 2 :

1° la subvention forfaitaire de base est calculée proportionnellement, compte tenu de la part que représente le nombre de fonctions de base réalisées par rapport à la norme requise de quatre fonctions de base;

2° pour la subvention de personnel, l'unité de calcul minimum est une fonction de personnel à mi-temps par tranche de deux fonctions de base réalisées et subventionnées;

3° la subvention de fonctionnement est calculée conformément aux dispositions de l'article 17, en tenant compte des fonctions de base réalisées.
